...
def create_backtesting_figure(df, executors, config, mode: str = "line", rows = 2):
    """
    Create a Plotly figure for backtesting visualization
    :param df: DataFrame with historical data
    :param executors: List of executor objects
    :param config: Configuration dictionary
    :param mode: Plotting mode, either "line" or "candlestick"
    """
    # Create subplots
    ...
    fig.update_yaxes(title_text="Price", row=1, col=1, range=[df['low'].min(), df['high'].max()])
