...
from utils.data_manipulation import StrategyV1Data, SingleMarketStrategyV1Data
...
class PerformanceCandles(CandlesBase):
    def __init__(self,
        ...
        self.executors = executors_df if executor_version == "v2" else None
        ...
        if show_positions:
            self.add_positions()
        if show_pnl and executor_version == "v1":
        ...
        elif show_pnl and executor_version == "v2":
            self.add_pnl(data=self.executors.sort_values(by="close_datetime"),
                         ...
                         row_number=rows - 1 if show_quote_inventory_change and executor_version == "v1" else rows)
        if show_quote_inventory_change and executor_version == "v1":
